...
(function($) {
    ...
    ckav.carousel = function(element) {
        if ($().owlCarousel) {
            var carouselConfig, navLeft = '<i class="pe-7s-angle-left"></i>',
            ...
            carouselConfig = {
                ...
                mouseDrag: ckav.getvar(carouselObj.attr('data-carousel-mousedrag'), !0, 'b'),
                touchDrag: ckav.getvar(carouselObj.attr('data-carousel-touchdrag'), !0, 'b'),
                pullDrag: ckav.getvar(carouselObj.attr('data-carousel-pulldrag'), !0, 'b'),
                freeDrag: ckav.getvar(carouselObj.attr('data-carousel-freedrag'), !1, 'b'),
                ...
                mergeFit: ckav.getvar(carouselObj.attr('data-carousel-margefit'), !0, 'b'),
                autoWidth: ckav.getvar(carouselObj.attr('data-carousel-widthauto'), !1, 'b'),
                startPosition: ckav.getvar(carouselObj.attr('data-carousel-startpos'), 0, 'n'),
                URLhashListener: ckav.getvar(carouselObj.attr('data-carousel-hashurl'), !1, 'b'),
                ...
                lazyLoad: ckav.getvar(carouselObj.attr('data-carousel-lazyload'), !1, 'b'),
                lazyLoadEager: ckav.getvar(carouselObj.attr('data-carousel-dots'), 0, 'n'),
                autoplay: ckav.getvar(carouselObj.attr('data-carousel-autoplay'), !1, 'b'),
                autoplayTimeout: ckav.getvar(carouselObj.attr('data-carousel-autoplaytimeout'), 5000, 'n'),
                autoplayHoverPause: ckav.getvar(carouselObj.attr('data-carousel-hoverpause'), !1, 'b'),
                smartSpeed: ckav.getvar(carouselObj.attr('data-carousel-smartspeed'), 250, 'n'),
                autoplaySpeed: ckav.getvar(carouselObj.attr('data-carousel-autoplayspeed'), !1, 'b'),
    ...
    ckav.global_validation = {
        ...
        form_successMsg: "This feature is not available in the demo version.",
        successMsg: "",
        // errorMsg: "Oops! Looks like something went wrong. Please try again later."
        errorMsg: "This feature is not available in the demo version."
    }
    ...
    ckav.popupImageFunction = function(element) {
        element.magnificPopup({
            ...
            callbacks: {
                beforeOpen: function() {
                    this.st.image.markup = this.st.image.markup.replace('val_animClass1', 'mfp-figure mfp-with-anim')
                }
            },
        });
    }
        ...
        pageTransition: function() {
            if ($o.$sectionPost) {
                $o.$sectionPost.on("click", function() {
                    var thisObj = this;
                    var popupIs = $(thisObj).attr("href");
                    var transition = function() {
                        $(thisObj).addClass("active-navigation");
                        ...
                        setTimeout(function() {
                            ...
                            if(popupIs == '#services')
                            {
                                // make info boxes equal
                                var maxHeight = 0;
                                $("#services .info-box-01").each(function() {
                                    if ($(thisObj).outerHeight() > maxHeight) {
                                        maxHeight = $(thisObj).outerHeight();
                                    }
                                }).height(maxHeight - 50);
                            }
                        }, 300)
                    ...
                    var marquee = $(thisObj).data('marquee');
                    if(typeof(marquee) !== 'undefined')
                    {
                        $(popupIs + ' select').val(marquee);
                        $o.$closeSection.trigger('click');
                        setTimeout(function() {
                            transition();
                        }, 800);
                    }
    ...
    ckav.getObj = function() {
        var obj = {
            ...
            $ckavBody: $(".ckav-body"),
            $pageloader: $("#loader"),
            $backgroundImage: $("[data-bg-image]").length > 0 ? $("[data-bg-image]") : !1,
            $backgroundColor: $("[data-bg-color]").length > 0 ? $("[data-bg-color]") : !1,
            $linearGradient: $("[data-linear-gradient]").length > 0 ? $("[data-linear-gradient]") : !1,
            $radialGradient: $("[data-radial-gradient]").length > 0 ? $("[data-radial-gradient]") : !1,
            $parallaxmage: $("[data-bgholder='parallax-image']").length > 0 ? $("[data-bgholder='parallax-image']") : !1,
            $slideshow: $("[data-bgholder='slideshow']").length > 0 ? $("[data-bgholder='slideshow']") : !1,
            $youVideo: $("[data-bgholder='yvideo']").length > 0 ? $("[data-bgholder='yvideo']") : !1,
            $hostVideo: $("[data-bgholder='hvideo']").length > 0 ? $("[data-bgholder='hvideo']") : !1,
            $menuIcon: $(".menu-icon").length > 0 ? $(".menu-icon") : !1,
            $extraPageLink: $(".e-page-link").length > 0 ? $(".e-page-link") : !1,
            $carouselWidget: $(".carousel-widget").length > 0 ? $(".carousel-widget") : !1,
            $forms: $(".form-widget").length > 0 ? $(".form-widget") : !1,
            $tooltip: $('[data-toggle="tooltip"]').length > 0 ? $('[data-toggle="tooltip"]') : !1,
            $zoomGallery: $("[data-zoom-gallery='yes']").length > 0 ? $("[data-zoom-gallery='yes']") : !1,
