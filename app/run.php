...
if (is_admin()) {
    ...
    require APP . 'routes/event_marquee' . EXT;
    require APP . 'routes/marquee_feature' . EXT;
    require APP . 'routes/service' . EXT;
    require APP . 'routes/slider_images' . EXT;
    require APP . 'routes/services_list' . EXT;
    require APP . 'routes/marquee_image' . EXT;
    require APP . 'routes/marquee_reservation' . EXT;
} else {
