...
<html>
  ...
  <body>
    <div id="start">
      <img src="<?php echo $base; ?>/app/views/assets/img/logo.png" alt="Anchor logo">
    ...
    <div id="loading" hidden>
      <img class="loadAnchor" src="<?php echo $base; ?>/app/views/assets/img/logo.png" alt="Anchor logo">
    ...
    <script type="text/javascript" src="<?php echo $base; ?>/app/views/assets/js/zepto.js"></script>
    <script>
      var sendAjax;
      ( function ( $ ) {
