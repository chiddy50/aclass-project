...
<header class="wrap">
  <h1><?php echo "Editing ".$marquee_feature->name; ?></h1>
</header>

<section class="wrap">
    <form method="post" action="<?php echo Uri::to('admin/marquee-feature/edit/' . $marquee_feature->id); ?>" novalidate>
        <input name="token" type="hidden" value="<?php echo $token; ?>">

        <fieldset class="split">
            <p>
                <label for="label-name"><?php echo __('marquee_feature.name'); ?>:</label>
                <?php echo Form::text('name', Input::previous('name', $marquee_feature->name), ['id' => 'label-name']); ?>
        ...
        <aside class="buttons">
            ...
            <?php echo Html::link('admin/marquee-feature/delete/' . $marquee_feature->id, __('global.delete'), [
